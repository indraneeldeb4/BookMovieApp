...
<div className='header'>
      ...
      <div className='logoContainer'>
        <img className='logo' height='35' src={logo} alt='logo'></img>
      </div>
      <div className='buttonContainer'>
      <div className='logged'>
      <Link className='bookshowLink' to="/bookshow/id=1">
        { props.bookShow && <button className='bookShowbtn'>Book show</button> }
      </Link>
      { login ? <button className='log'>Logout</button> : <button className='log'>Login</button> }
      </div>
      </div>
    </div>
